...
export const PostMovied = async(moviereg) => {
  try{
    return await axios.post(`${API_URL}/watched/add`
    ,moviereg)
  }catch(error){
    console.log('Error while calling getWatched api',error.message)
  }
...
export const PutMovied = async(moviereg) => {
  try{
    return await axios.put(`${API_URL}/movielist/moviedetail/update`
    ,moviereg)
  }catch(error){
    console.log('Error while calling getWatched api',error.message)
  }
...
export const PutNextMovied = async(moviereg) => {
  try{
    return await axios.put(`${API_URL}/movielist/nextmoviedetail/update`
    ,moviereg)
  }catch(error){
    console.log('Error while calling getWatched api',error.message)
  }
...
export const PostNextMovied = async(moviereg) => {
  try{
    return await axios.post(`${API_URL}/nextwatched/add`
    ,moviereg)
  }catch(error){
    console.log('Error while calling getWatched api',error.message)
  }
...
export const deleteMovied = async(id) => {
  try{
    return await axios.delete(`${API_URL}/movielist/moviedetail/deleteItem/${id}`)
  }catch(error){
...
export const deleteNextMovied = async(id) => {
  try{
    return await axios.delete(`${API_URL}/nextmovielist/moviedetail/deleteItem/${id}`)
  }catch(error){
    console.log('Error while calling deleteUser api',error.message);
  }
}
