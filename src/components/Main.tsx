  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/searchmovie' element={<SearchMovie fetchUrl={requests.feactTopRated}/>} /> 
        <Route path='/searchmovie/editmovie' element={<EditMovied />} /> 
        <Route path='/searchmovie/editnextmovie' element={<EditNextMovied />} /> 
        <Route path='/watchedlist/moviedetail' element={<MoviedDetail />} /> 
        <Route path='/nextwatchedlist/moviedetail' element={<MoviedDetail />} /> 
      </Routes>
    </BrowserRouter>
    </div>
  );
